...
SELECT        dbo.Stores_Scan.GardID, dbo.Stores_Scan.ScanDate, dbo.Stores_Scan.StoreID, dbo.Stores_Scan.ProunchID, dbo.Stores_Scan.COMP_ID, dbo.Stores.store_name, dbo.Stores_Scan_items.Item_Id, 
                         dbo.Items.Item_Name, dbo.Stores_Scan_items.TotalByHande, dbo.Stores_Scan_items.TotalByComputer, dbo.Stores_Scan_items.CalcCompAndHand, dbo.unit.unitname, dbo.Items.priceCome, dbo.Items.PartNo, 
                         dbo.Stores_Scan_items.ValDeff
