...
CREATE VIEW [dbo].[View_Stores_Consumer]
AS
SELECT        dbo.Stores_Consumer.GardID, dbo.Stores_Consumer.ScanDate, dbo.Stores_Consumer.StoreID, dbo.Stores_Consumer.ProunchID, dbo.Stores_Consumer.COMP_ID, dbo.Stores.store_name, 
                         ...
                         dbo.Stores_Consumer_items.Cash_purchases, dbo.Stores_Consumer_items.AllCome, dbo.Stores_Consumer_items.CurrentBalance, dbo.Stores_Consumer_items.NetOut
