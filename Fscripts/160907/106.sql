...
SELECT        dbo.Stores_Transfares.TransId, dbo.Stores.store_name, dbo.Groups.groupname, dbo.Items.Item_Name, dbo.Stores_Transfares.TransDate, dbo.Stores_Transfares_items.Unite, 
                         ...
                         dbo.TblCostTree.AccName AS CostName
FROM            dbo.Stores INNER JOIN
                         ...
                         dbo.Stores_Transfares_items ON dbo.Items.Item_Id = dbo.Stores_Transfares_items.itemid ON dbo.Stores_Transfares.TransId = dbo.Stores_Transfares_items.TransId LEFT OUTER JOIN
