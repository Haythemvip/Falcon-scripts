...
AS
SELECT        dbo.Amr_Sheraa_Item.performa_id, dbo.Amr_Sheraa.performa_date, dbo.Amr_Sheraa.customername, dbo.Amr_Sheraa_Item.serial, dbo.Amr_Sheraa_Item.item_name, dbo.Amr_Sheraa_Item.price, 
                         dbo.Amr_Sheraa_Item.unit, dbo.Amr_Sheraa_Item.quantity, dbo.Amr_Sheraa_Item.total, dbo.TblCostTree.AccName, dbo.TblCostTree.ParentID, TblCostTree_1.AccName AS AccNameMain, 
                         dbo.Amr_Sheraa_Item.CostID, dbo.Amr_Sheraa.order_no, dbo.Amr_Sheraa_Item.ItemNO_IN_Tender, dbo.Amr_Sheraa_Item.ItemCode, dbo.Amr_Sheraa_Item.mohla, dbo.Amr_Sheraa_Item.DateNeed, 
                         dbo.CostItemsBudget.Budget, dbo.CostItemsBudget.SupID, dbo.Amr_Sheraa.ProjectID
