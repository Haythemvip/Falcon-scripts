...
ALTER   PROCEDURE [dbo].[GridTable_Stores]
    @MovmentID INT ,
    @year INT ,
    @DefultQ FLOAT = 1 , --ÇáßãíÉ ÇáãÑÇÏ ÊÌãíÚåÇ 
    @ActionDate DATE ,
    @StoreID INT = 0 ,
...
AS
    BEGIN
        ...
        CREATE TABLE #temp
            (
              Srial BIGINT NULL ,--ãÓáÓá
              ItemCode BIGINT , -- ßæÏ ÇáÕäÝ
              ItemName NVARCHAR(100) COLLATE Arabic_CI_Ai ,-- ÇÓã ÇáÕäÝ
              unit NCHAR(10) ,-- ÇáæÍÏÉ Çá Êã ÈíåÇ ÇáÈíÚ
              price FLOAT ,-- ÓÚÑ ÇáÈíÚ Úáì ÍÓÈ æÍÏÉ ÇáÈíÚ
              Q FLOAT ,-- ÇáßãíÉ ÇáãÈÇÚÉ Úáì ÍÓÈ æÍÏÉ ÇáÈíÚ
              Total FLOAT ,-- ÇáÇÌãÇáì
              SN NVARCHAR(MAX) ,-- ÇáÓÑíÇá
              Balance FLOAT ,-- ÇáÑÕíÏ ÇáÝÚáì ÇËäÇÁ ÇáÈíÚ Úáì ÍÓÈ æÍÏÉ ÇáÈíÚ
              Bounas FLOAT ,-- ÇáÈæäÕ
              Unit_Quantity FLOAT ,-- ÇáßãíÉ Úáì ÍÓÈ ÇáæÍÏÉ ÇáÑÆíÓíÉ
              Unit_Price DECIMAL(18, 4) ,-- ÇáÓÚÑ Úáì ÍÓÈ ÈíÚ ÇáæÍÏÉ ÇáÑÆíÓíÉ
              CostID INT ,-- ãÑßÒ ÇáÊßáÝÉ
              CostName NVARCHAR(MAX) COLLATE Arabic_CI_Ai ,--ãÑßÒ ÇáÊßáÝÉ
              Defualt_ItemCost DECIMAL(18, 4) ,-- ÇáÊßáÝÉ Úáì ÍÓÈ ÇáæÍÏÉ ÇáÑÆíÓíÉ
              UnitCost FLOAT ,-- ÇáÊßáÝÉ Úáì ÍÓÈ ÇáæÍÏÉ ÇáãÈÇÚÉ 
              Unit_Balance FLOAT ,-- ÇáÑÕíÏ ÇáÝÚáì ááÈíÚ Úáì ÍÓÈ ÇáæÍÏÉ ÇáÑÆíÓíÉ
              Rate FLOAT ,-- ãÚÏá ÇáÊÍæíá Èíä ÇáæÍÏÇÊ ÍÓÈ ÇáæÍÏÉ ÇáãÈÇÚå
              CostAllItemOut FLOAT ,-- ÇÌãÇáì ÊßáÝÉ ÇáÈÖÇÚå Úáì ÍÓÈ ÇáæÍÏÉ ÇáÑÆíÓíÉ
              maksap FLOAT ,-- ãßÓÈ ÇáÕäÝ
              PreviousQTY FLOAT ,-- ÇáßãíÉ ÇáÓÇÈÞÉ ãä ÇáÕäÝ Ýì ÍÇáÉ ÇáÊÚÏíá Úáì ÇáÕäÝ 
              Tax DECIMAL(18, 4) ,--ÖÑíÈå
              PriceFexed BIT ,--áãÚÑÝÉ åá íãßä ÇáÊÚÏíá Úáì ÇáÓÚÑ ÇËäÇÁ ÇáÈíÚ Çã áÇ 
              itm_ismedicine BIT , -- áãÚÑÝÉ åá åæ ÕäÝ Çã ÎÏãÉ 
              Item_Unit_Id INT
            )
