...
CREATE    PROCEDURE [dbo].[Sallery_Cost_Vocabulary]
    @FromDate DATE ,
    @ToDate DATE ,
    @GroupID INT ,
    @Lang CHAR(3) = 'AR'
AS
    BEGIN
        ...
        VALUES  ( 1, -- Vocabulary_ID - bigint
                  N'«·«”«”Ï'  -- Vocabulary - nvarchar(50)
                  )
                
				 INSERT  INTO #Title
                ( Vocabulary_ID, Vocabulary )
        VALUES  ( 2, -- Vocabulary_ID - bigint
                  N'»œ· ÿ»Ì⁄… ⁄„·'  -- Vocabulary - nvarchar(50)
                  )

				   INSERT  INTO #Title
                ( Vocabulary_ID, Vocabulary )
        VALUES  ( 3, -- Vocabulary_ID - bigint
                  N'»œ· ÿ⁄«„'  -- Vocabulary - nvarchar(50)
                  )
        ...
        VALUES  ( 4, -- Vocabulary_ID - bigint
                  N'»œ· «‰ ﬁ«·'  -- Vocabulary - nvarchar(50)
                  )

				   INSERT  INTO #Title
                ( Vocabulary_ID, Vocabulary )
        VALUES  ( 5, -- Vocabulary_ID - bigint
                  N'»œ· ”ﬂ‰'  -- Vocabulary - nvarchar(50)
                  )
        ...
        VALUES  ( 6, -- Vocabulary_ID - bigint
                  N'»œ·  ·Ì›Ê‰'  -- Vocabulary - nvarchar(50)
                  )
        ...
        VALUES  ( 7, -- Vocabulary_ID - bigint
                  N'»œ· „œ«—”'  -- Vocabulary - nvarchar(50)
                  )

				   INSERT  INTO #Title
                ( Vocabulary_ID, Vocabulary )
        VALUES  ( 8, -- Vocabulary_ID - bigint
                  N'»œ· ‰”»…'  -- Vocabulary - nvarchar(50)
                  )
        ...
        VALUES  ( 9, -- Vocabulary_ID - bigint
                  N'»œ·«  «Œ—Ì'  -- Vocabulary - nvarchar(50)
                  )
