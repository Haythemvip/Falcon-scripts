...
ALTER    PROCEDURE [dbo].[Sallery_Cost_Vocabulary]
    @FromDate DATE ,
    @ToDate DATE ,
    @GroupID INT ,
    @Lang CHAR(3) = 'AR'
    ...
    BEGIN
        ...
        CREATE TABLE #Result
            (
              ...
              Vocabulary_ID INT ,
              Vocabulary NVARCHAR(50) COLLATE Arabic_CI_AS ,
              Amount FLOAT ,
              CostGroup_ID INT ,
        ...
        VALUES  ( 1, -- Vocabulary_ID - bigint
                  N'01-«·«”«”Ï'  -- Vocabulary - nvarchar(50)
                  )
                
				 INSERT  INTO #Title
                ( Vocabulary_ID, Vocabulary )
        VALUES  ( 2, -- Vocabulary_ID - bigint
                  N'02-»œ· ÿ»Ì⁄… ⁄„·'  -- Vocabulary - nvarchar(50)
                  )

				   INSERT  INTO #Title
                ( Vocabulary_ID, Vocabulary )
        VALUES  ( 3, -- Vocabulary_ID - bigint
                  N'03-»œ· ÿ⁄«„'  -- Vocabulary - nvarchar(50)
                  )


				   INSERT  INTO #Title
                ( Vocabulary_ID, Vocabulary )
        VALUES  ( 4, -- Vocabulary_ID - bigint
                  N'04-»œ· «‰ ﬁ«·'  -- Vocabulary - nvarchar(50)
                  )

				   INSERT  INTO #Title
                ( Vocabulary_ID, Vocabulary )
        VALUES  ( 5, -- Vocabulary_ID - bigint
                  N'05-»œ· ”ﬂ‰'  -- Vocabulary - nvarchar(50)
                  )


				   INSERT  INTO #Title
                ( Vocabulary_ID, Vocabulary )
        VALUES  ( 6, -- Vocabulary_ID - bigint
                  N'06-»œ·  ·Ì›Ê‰'  -- Vocabulary - nvarchar(50)
                  )


				   INSERT  INTO #Title
                ( Vocabulary_ID, Vocabulary )
        VALUES  ( 7, -- Vocabulary_ID - bigint
                  N'07-»œ· „œ«—”'  -- Vocabulary - nvarchar(50)
                  )

				   INSERT  INTO #Title
                ( Vocabulary_ID, Vocabulary )
        VALUES  ( 8, -- Vocabulary_ID - bigint
                  N'08-»œ· ‰”»…'  -- Vocabulary - nvarchar(50)
                  )


				   INSERT  INTO #Title
                ( Vocabulary_ID, Vocabulary )
        VALUES  ( 9, -- Vocabulary_ID - bigint
                  N'09-»œ·«  «Œ—Ì'  -- Vocabulary - nvarchar(50)
                  )


				  	   INSERT  INTO #Title
                ( Vocabulary_ID, Vocabulary )
        VALUES  ( 10, -- Vocabulary_ID - bigint
                  N'10-«·«÷«›Ï'  -- Vocabulary - nvarchar(50)
                  )


				  		  	   INSERT  INTO #Title
                ( Vocabulary_ID, Vocabulary )
        VALUES  ( 11, -- Vocabulary_ID - bigint
                  N'11-«·ÕÊ«›“'  -- Vocabulary - nvarchar(50)
                  )

				  		  	   INSERT  INTO #Title
                ( Vocabulary_ID, Vocabulary )
        VALUES  ( 12, -- Vocabulary_ID - bigint
                  N'12-«·Œ’Ê„« '  -- Vocabulary - nvarchar(50)
                  )


				  		  	   INSERT  INTO #Title
                ( Vocabulary_ID, Vocabulary )
        VALUES  ( 13, -- Vocabulary_ID - bigint
                  N'13-Œ’„  «ŒÌ—'  -- Vocabulary - nvarchar(50)
                  )


				  		  	   INSERT  INTO #Title
                ( Vocabulary_ID, Vocabulary )
        VALUES  ( 14, -- Vocabulary_ID - bigint
                  N'14-Œ’„ €Ì«»'  -- Vocabulary - nvarchar(50)
                  )
				  		  	   ...
				  		  	   INSERT  INTO #Title
                ( Vocabulary_ID, Vocabulary )
        VALUES  ( 15, -- Vocabulary_ID - bigint
                  N'15-«·”·›'  -- Vocabulary - nvarchar(50)
                  )


				  		  	   INSERT  INTO #Title
                ( Vocabulary_ID, Vocabulary )
        VALUES  ( 16, -- Vocabulary_ID - bigint
                  N'16-«· «„Ì‰« '  -- Vocabulary - nvarchar(50)
                  )
	 ...
	 -- «·«”«”Ï
	   ...
	   -- »œ· ÿ»Ì⁄… ⁄„·
        ...
        SET     Amount = ( SELECT   SUM(b_tab)
				  ...
				  -- »œ· „œ«—”  
        UPDATE  #Result
        SET     Amount = ( SELECT   SUM(Take_Schole)
                           FROM     #Render
                                    WHERE  CostID = #Render.AccCode
				  ...
				  -- »œ· ‰”»…  
        UPDATE  #Result
        SET     Amount = ( SELECT   SUM(Take_Percent)
                           FROM     #Render
                                    WHERE  CostID = #Render.AccCode
				  ...
				  -- »œ· «Œ—Ì  
        UPDATE  #Result
        SET     Amount = ( SELECT   SUM(b_malbas)
                           FROM     #Render
                                    WHERE  CostID = #Render.AccCode
				  ...
				  WHERE Vocabulary_ID =9
				  			  ...
				  			  -- «·«÷«›Ï  
        UPDATE  #Result
        SET     Amount = ( SELECT   SUM(ed_agaza)
                           FROM     #Render
                                    WHERE  CostID = #Render.AccCode
        ...
        SET     Amount = ( SELECT   SUM(gaza)
				  ...
				  WHERE Vocabulary_ID = 12
				  			  ...
				  			  -- Œ’„  «ŒÌ—  
        UPDATE  #Result
        SET     Amount = ( SELECT   SUM(moneytakher)
                           FROM     #Render
                                    WHERE  CostID = #Render.AccCode
				  ...
				  WHERE Vocabulary_ID = 13
				  			  ...
				  			  -- Œ’„ €Ì«»  
        UPDATE  #Result
        SET     Amount = ( SELECT   SUM(moneygyab)
                           FROM     #Render
                                    WHERE  CostID = #Render.AccCode
				  ...
				  WHERE Vocabulary_ID = 14
				  			  ...
				  			  -- ”·›Â
        UPDATE  #Result
        SET     Amount = ( SELECT   SUM(solfa_cut)
                           FROM     #Render
                                    WHERE  CostID = #Render.AccCode
        ...
        SELECT  *
        FROM    #Result ORDER BY Vocabulary_ID ; 
