...
CREATE VIEW [dbo].[View_Documentary_of_Guarantee_Used]
AS
SELECT        dbo.Documentary_of_Guarantee_Used.ID, dbo.Documentary_of_Guarantee_Used.Collateral_ID, dbo.Documentary_of_Guarantee_Used.Collateral_NO, dbo.Documentary_of_Guarantee_Used.Opration, 
                         ...
                         dbo.Documentary_of_Guarantee_Used.NewINs, dbo.Documentary_of_Guarantee_Used.VendorID, dbo.Curaunes.CurName, dbo.TblCostTree.AccName, dbo.OstazCode.OstazName, 
                         dbo.suppliers.suppliers_name
