...
FROM            dbo.Shiping_Details RIGHT OUTER JOIN
                         dbo.ShipingBill LEFT OUTER JOIN
                         dbo.customers ON dbo.ShipingBill.ShiperID = dbo.customers.Customer_id ON dbo.Shiping_Details.ShipingID = dbo.ShipingBill.ShipingID LEFT OUTER JOIN
