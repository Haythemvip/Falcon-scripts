...
SELECT        TOP (100) PERCENT tblAccTree_1.AccCode AS F1, tblAccTree_1.AccName AS N1, tblAccTree_2.AccCode AS F2, tblAccTree_2.AccName AS N2, tblAccTree_3.AccCode AS F3, tblAccTree_3.AccName AS N3, 
                         ...
                         dbo.tblAccTree.AccCode AS F10, dbo.tblAccTree.AccName AS N10, tblAccTree_4.ParentID, tblAccTree_4.AccType, tblAccTree_4.ISmain, tblAccTree_4.MezanyaID, tblAccTree_4.ACC_Type_ID, 
                         tblAccTree_4.LongCode, dbo.Acc_Type_tree.Type_Name, dbo.FinalBalanceTypes.ClassificationId, dbo.FinalBalanceTypes.ClassificationName, dbo.Mezanya.Mezanya_Name, 
                         dbo.Account_Group.AccountGroup_ID, dbo.Account_Group.AccountGroup_Name, MainTblAcctree.AccCode, MainTblAcctree.AccName, MainTblAcctree.SortID, MainTblAcctree.AccName_En
FROM            dbo.Account_Group RIGHT OUTER JOIN
                         dbo.tblAccTree AS tblAccTree_4 INNER JOIN
                         dbo.tblAccTree AS MainTblAcctree ON tblAccTree_4.ID = MainTblAcctree.ID ON dbo.Account_Group.AccountGroup_ID = tblAccTree_4.AccountGroup_ID LEFT OUTER JOIN
