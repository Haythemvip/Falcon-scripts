...
SELECT        dbo.Amr_Sheraa_Item.performa_id, dbo.Amr_Sheraa.performa_date, dbo.Amr_Sheraa.customername, dbo.Amr_Sheraa_Item.serial, dbo.Amr_Sheraa_Item.price, dbo.Amr_Sheraa_Item.unit, 
                         ...
                         dbo.CostItemsBudget.SupID, dbo.Amr_Sheraa.ProjectID, dbo.Items.Item_Name AS Item_Name_EN, dbo.Items.Item_Name_AR, dbo.Amr_Sheraa.PO_NO, dbo.Amr_Sheraa_Item.item_name, 
                         dbo.Amr_Sheraa.Discount, dbo.Amr_Sheraa.Emp_Code, dbo.Amr_Sheraa.DepartID, dbo.Amr_Sheraa.PurchaseTypeID, dbo.Amr_Sheraa.ContactPesonID, dbo.Amr_Sheraa.ContactMobile, 
                         dbo.Amr_Sheraa.ContactMial, dbo.Amr_Sheraa.ProunchID, dbo.Amr_Sheraa.Customer_id
