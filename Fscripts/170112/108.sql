...
SELECT        dbo.Amr_Sheraa_Item.performa_id, dbo.Amr_Sheraa.performa_date, dbo.Amr_Sheraa.customername, dbo.Amr_Sheraa_Item.serial, dbo.Amr_Sheraa_Item.price, dbo.Amr_Sheraa_Item.unit, 
                         ...
                         dbo.Amr_Sheraa.ProunchID, dbo.Amr_Sheraa.Customer_id, dbo.Tenders_Add.TheName, dbo.Tenders_Add.ShortName, dbo.Tenders_Add.ShortCode
FROM            dbo.Amr_Sheraa INNER JOIN
                         ...
                         dbo.Tenders_Add ON dbo.Amr_Sheraa.ProjectID = dbo.Tenders_Add.ID LEFT OUTER JOIN
