...
ALTER VIEW [dbo].[View_Amr_Sheraa]
AS
SELECT        dbo.Amr_Sheraa.performa_id, dbo.Amr_Sheraa.Customer_id, dbo.Amr_Sheraa.customername, dbo.Amr_Sheraa.contactcmb, dbo.Amr_Sheraa.performa_date, dbo.Amr_Sheraa.intro, 
                         ...
                         dbo.Amr_Sheraa.depart_name, dbo.Amr_Sheraa.flag, dbo.Amr_Sheraa.ProunchID, dbo.Amr_Sheraa.COMP_ID, dbo.Amr_Sheraa_Item.serial, dbo.Amr_Sheraa_Item.item_name, dbo.Amr_Sheraa_Item.price, 
                         dbo.Amr_Sheraa_Item.unit, dbo.Amr_Sheraa_Item.quantity, dbo.Amr_Sheraa_Item.total AS TotalItem, dbo.Amr_Sheraa_Item.ConstControl, dbo.Amr_Sheraa_Item.ConstControlStart, 
                         ...
                         dbo.Amr_Sheraa_Item.TotlAccount, dbo.Amr_Sheraa_Item.TotalExcutive, dbo.Amr_Sheraa_Item.TotalGm, dbo.Amr_Sheraa.order_no, dbo.Amr_Sheraa.OrderNotes, dbo.TblCostTree.AccName, 
                         dbo.Amr_Sheraa_Item.ItemCode
