...
ALTER VIEW [dbo].[View_Letter_of_Guarantee_Used]
AS
SELECT        dbo.Letter_of_Guarantee_Used.ID, dbo.Letter_of_Guarantee_Used.Collateral_ID, dbo.Letter_of_Guarantee_Used.Collateral_NO, dbo.Letter_of_Guarantee_Used.Opration, 
                         ...
                         dbo.Letter_of_Guarantee_Used.JournalEnd, dbo.Letter_of_Guarantee_Used.KIdIDEnd, dbo.Letter_of_Guarantee_Used.NewValue, dbo.Letter_of_Guarantee_Used.NewINs, dbo.Letter_of_Guarantee_Used.ProjectID,
                          dbo.Tenders_Add.TheName, dbo.Letter_of_Guarantee_Used.VedorID, dbo.suppliers.suppliers_name, dbo.collateral.ID AS LetterTypeID
FROM            dbo.Letter_of_Guarantee_Used INNER JOIN
                         ...
                         dbo.suppliers ON dbo.Letter_of_Guarantee_Used.VedorID = dbo.suppliers.suppliers_id LEFT OUTER JOIN
                         dbo.Tenders_Add ON dbo.Letter_of_Guarantee_Used.ProjectID = dbo.Tenders_Add.ID LEFT OUTER JOIN
