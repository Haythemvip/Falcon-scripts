...
SELECT        dbo.Loan_Used.ID, dbo.Loan_Used.Collateral_ID, dbo.Loan_Used.Collateral_NO, dbo.Loan_Used.Opration, dbo.Loan_Used.Collateral_Value, dbo.Loan_Used.Collateral_Rat, dbo.Loan_Used.Collateral_Mony, 
                         dbo.Loan_Used.Notes, dbo.Loan_Used.Date_Strat, dbo.Loan_Used.Date_End, dbo.Loan_Used.commission, dbo.LoanType.Collateral_AR, dbo.LoanType.Collateral_EN, dbo.BankAccountName.AccountID, 
                         ...
                         dbo.Loan_Used.ProjectID, dbo.Tenders_Add.TheName, dbo.Loan_Used.VedorID, dbo.suppliers.suppliers_name, dbo.LoanType.ID AS LetterTypeID
FROM            dbo.Loan_Used INNER JOIN
                         dbo.LoanType ON dbo.Loan_Used.Collateral_ID = dbo.LoanType.ID INNER JOIN
