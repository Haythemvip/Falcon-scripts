...
SELECT        TOP (100) PERCENT dbo.Items.Item_Name, dbo.Stores.store_name, dbo.Item_Card.VenderOrCustomer, dbo.Item_Card.EznNO, dbo.Item_Card.InvNO, dbo.Item_Card.ActionDate, dbo.Item_Card.QCome, 
                         ...
                         dbo.Items.itm_code2, dbo.Items.CountInBox, dbo.Items.Thikness, dbo.Items.highet, dbo.Items.Width, unit_1.unitname AS UnitMedum, unit_2.unitname AS UnitSmall, dbo.Item_Card.LonID, 
                         dbo.Item_Card.SarfOhdID, dbo.Item_Card.SaleUnitID, dbo.Item_Card.SaleRate, dbo.Item_Card.SaleQuantity, dbo.Item_Card.SalePrice, unit_3.unitname AS SaleUnit
FROM            dbo.Items INNER JOIN
                         ...
                         dbo.unit AS unit_3 ON dbo.Item_Card.SaleUnitID = unit_3.unitcode LEFT OUTER JOIN
