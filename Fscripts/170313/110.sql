...
SELECT        dbo.Mardodat_Invoice_Com_NotTax.InvoiceNo, dbo.Mardodat_Invoice_Com_NotTax.idate, dbo.Mardodat_Invoice_Com_NotTax.ClientID, dbo.Mardodat_Invoice_Com_NotTax.aTotal, 
                         ...
                         dbo.Mardodat_Invoice_Com_NotTax.Journal, dbo.Mardodat_Invoice_Com_NotTax.BoxID, dbo.Mardodat_Invoice_Com_NotTax.CostID, dbo.Mardodat_Invoice_Com_NotTax_Items.ItemCost, 
                         dbo.Mardodat_Invoice_Com_NotTax_Items.ItemMaksab, dbo.Mardodat_Invoice_Com_NotTax_Items.DefaltCost, dbo.Mardodat_Invoice_Com_NotTax_Items.CostId AS Expr1, 
                         dbo.Mardodat_Invoice_Com_NotTax_Items.Rate, dbo.Mardodat_Invoice_Com_NotTax_Items.Unit_Quantity, dbo.Mardodat_Invoice_Com_NotTax_Items.Unit_Price, 
                         dbo.Mardodat_Invoice_Com_NotTax_Items.Unit_Balance, dbo.Mardodat_Invoice_Com_NotTax_Items.CostAllItemOut, dbo.Mardodat_Invoice_Com_NotTax_Items.UnitCost, 
                         dbo.Mardodat_Invoice_Com_NotTax_Items.SaleUnitID, dbo.Mardodat_Invoice_Com_NotTax_Items.Defualt_ItemCost, dbo.TblCostTree.AccName
FROM            dbo.Stores INNER JOIN
                         ...
                         dbo.TblCostTree ON dbo.Mardodat_Invoice_Com_NotTax_Items.CostId = dbo.TblCostTree.AccCode LEFT OUTER JOIN
