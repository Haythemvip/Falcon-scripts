...
SELECT        dbo.View_tblAccTree.AccCode, dbo.View_tblAccTree.AccName, dbo.El_Koyod_El_Yawmia.KaidID, dbo.El_Koyod_El_Yawmia.Detis, dbo.El_Koyod_El_Yawmia.Daen, dbo.El_Koyod_El_Yawmia.Maden, 
                         ...
                         dbo.View_tblAccTree.N8, dbo.View_tblAccTree.F9, dbo.View_tblAccTree.N9, dbo.View_tblAccTree.F10, dbo.View_tblAccTree.N10, dbo.View_tblAccTree.MezanyaID, dbo.El_Koyod_El_Yawmia.AccID, 
                         dbo.El_Koyod_El_Yawmia.year
FROM            dbo.El_Koyod_El_Yawmia INNER JOIN
