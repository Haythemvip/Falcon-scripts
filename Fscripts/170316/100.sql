...
SELECT        dbo.El_Koyod_El_Yawmia.KaidID, dbo.El_Koyod_El_Yawmia.Detis, dbo.El_Koyod_El_Yawmia.AccID, dbo.El_Koyod_El_Yawmia.AccName AS AccountName, dbo.El_Koyod_El_Yawmia.Daen, 
                         ...
                         dbo.El_Koyod_El_Yawmia.UserAA, dbo.View_tblAccTree.AccCode, dbo.View_tblAccTree.AccName, dbo.View_tblAccTree.MezanyaID, dbo.View_tblAccTree.ISmain, dbo.View_tblAccTree.N10, 
                         dbo.View_tblAccTree.F10, dbo.View_tblAccTree.N9, dbo.View_tblAccTree.F9, dbo.View_tblAccTree.N8, dbo.View_tblAccTree.F8, dbo.View_tblAccTree.N7, dbo.View_tblAccTree.F7, dbo.View_tblAccTree.N6, 
                         dbo.View_tblAccTree.F6, dbo.View_tblAccTree.N5, dbo.View_tblAccTree.F5, dbo.View_tblAccTree.N4, dbo.View_tblAccTree.F4, dbo.View_tblAccTree.N3, dbo.View_tblAccTree.F3, dbo.View_tblAccTree.N2, 
                         dbo.View_tblAccTree.F2, dbo.View_tblAccTree.N1, dbo.View_tblAccTree.F1, dbo.El_Koyod_El_Yawmia.OstasName, dbo.El_Koyod_El_Yawmia.AccName2, dbo.El_Koyod_El_Yawmia.Acccode2, 
                         dbo.El_Koyod_El_Yawmia.DocJorrnal, 0 AS raseed, ISNULL(dbo.El_Koyod_El_Yawmia.CaseID, 0) AS CaseID, dbo.El_Koyod_El_Yawmia.CaseName, dbo.El_Koyod_El_Yawmia.DocNO, 
                         dbo.El_Koyod_El_Yawmia.Destination
