...
ALTER VIEW [dbo].[View_Documentary_ChangeValue]
AS
SELECT        dbo.Documentary_ChangeValue.ID, dbo.Documentary_ChangeValue.Letter_ID, dbo.Documentary_ChangeValue.Collateral_NO, dbo.Documentary_ChangeValue.Notes, dbo.Documentary_ChangeValue.ChangeDate,
                          dbo.Documentary_ChangeValue.commission, dbo.Documentary.Collateral_AR, dbo.Documentary.Collateral_EN, dbo.Bank_Code.Bank_Name, dbo.Documentary_ChangeValue.NewValue, 
                         dbo.Documentary_ChangeValue.insurance, dbo.Documentary_ChangeValue.Orginal_INS, dbo.Documentary_ChangeValue.Orginal_Value
