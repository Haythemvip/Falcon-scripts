...
SELECT        dbo.invoiceoutitem.InvoiceNo, dbo.invoiceoutitem.serialitem, dbo.invoiceoutitem.unit, dbo.invoiceoutitem.PriceOne, dbo.invoiceoutitem.Q, dbo.invoiceoutitem.TotalPrice, dbo.invoiceout.idate, 
                         ...
                         dbo.invoiceoutitem.Valitemtax, dbo.invoiceout.Extra_Tax, 'Tax' AS TaxType, dbo.invoiceout.Mandop_Name, dbo.invoiceout.Journal, dbo.invoiceout.MandopID, dbo.Service_Type.Service_Type_Name
FROM            dbo.invoiceout INNER JOIN
                         ...
                         dbo.Service_Type ON dbo.invoiceout.saletype = dbo.Service_Type.Service_ID LEFT OUTER JOIN
