...
SELECT        TOP (100) PERCENT dbo.byan_item.InvoiceNo, dbo.byan_item.serialitem, dbo.byan_item.unit, dbo.byan_item.PriceOne, dbo.byan_item.Q, dbo.byan_item.TotalPrice, dbo.byan.idate, dbo.byan.ClientID, 
                         ...
                         dbo.byan.tahseldate, dbo.byan.Isused, dbo.byan.PrintedCount, dbo.byan.ProjectID_Tender_Item_ID, dbo.Service_Type.Service_Type_Name
FROM            dbo.TblCostTree RIGHT OUTER JOIN
                         dbo.Service_Type LEFT OUTER JOIN
                         ...
                         dbo.Service_Type.Service_ID = dbo.byan.saletype ON dbo.TblCostTree.AccCode = dbo.byan_item.CostId LEFT OUTER JOIN
